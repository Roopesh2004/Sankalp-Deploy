        ...
        <motion.div
          ...
          style={{
            background: `conic-gradient(from ${
              index * 60
            }deg, transparent, rgba(124, 58, 237, 0.5), transparent)`,
          }}
          animate={{ rotate: 360 }}
...
export const StudentDashboard: React.FC<StudentDashboardProps> = ({ reg }) => {
  ...
  useEffect(() => {
    if (selectedCourse) {
      const fetchCourseModules = async () => {
        try {
          const response = await fetch(
            `https://sankalp-deploy-1.onrender.com/api/course-modules/${selectedCourse}`
          );
          ...
          const materialsResponse = await fetch(
            `https://sankalp-deploy-1.onrender.com/api/module-materials/${selectedCourse}`
          );
          if (!materialsResponse.ok)
            throw new Error("Failed to fetch module materials");
              ...
              {showSettings ? (
                ...
                <>
                  ...
                  >
                    ...
                    >
                      Embark on your learning journey with our comprehensive
                      courses designed to elevate your skills
                    </motion.p>
                  </motion.div>
