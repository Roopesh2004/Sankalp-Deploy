...
export const RegisterForm: React.FC<RegisterFormProps> = ({ onLoginClick }) => {
  ...
  return (
    <div className="w-full max-w-md relative z-10">
      ...
      {!isVerifying && <form onSubmit={handleSubmit} className="form-container bg-black/80 backdrop-blur-lg border border-gray-800 p-8 rounded-2xl shadow-xl">
      ...
      {isVerifying && (
        <form onSubmit={handleVerifyOTP} className="mt-4">
          <div className="mb-4">
            <label htmlFor="otp" className="block text-sm font-medium uppercase bg-white text-gray-700 p-4 mb-5">
